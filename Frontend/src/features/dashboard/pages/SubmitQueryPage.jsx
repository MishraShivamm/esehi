...
export default function SubmitQueryPage() {
  ...
  const handleChange = (e) => {
    ...
    // Auto-set category when a book is selected
    if (name === "book") {
      setForm((prev) => ({ ...prev, [name]: value, category: value ? "book" : "general" }))
    }
  }
    ...
    return (
      <div className="max-w-lg mx-auto mt-10 rounded-lg border border-green-500/20 bg-green-500/10 px-6 py-8 text-center">
        ...
        <div className="flex gap-3 justify-center mt-6">
          ...
          <button
            onClick={() => { setSuccess(false); setForm({ book: "", subject: "", description: "", category: "general" }) }}
